...
function LoggedInView({ faults, refreshFaults, logout, theme, toggleTheme }) {
    ...
    const fetchLocations = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:3000/api/faults/locations",
          {
            headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3000/api/faults/report",
        {
          method: 'POST',
  ...
  const completeFault = async (faultId) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/api/faults/${faultId}`,
        {
          method: 'PATCH',
  ...
  return (
    ...
    <div className="logged-in-container">
      ...
      <div className="dashboard-actions ar-button-row">
        ...
        <button
          className="ar-button"
          onClick={() => setShowArPlaceholder(true)}
        >
          Open AR View
        </button>
        ...
        <div className="modal-overlay">
          ...
          <div className="modal-box">
            ...
            <p className="modal-description">
              Capture the location, asset class,
              and severity for the issue.
            </p>
            ...
            <div className="modal-form-group split-grid">
              ...
              <div>
                ...
                <select
                  value={asset_class}
                  onChange={(e) => setAsset_class(e.target.value)}
                >
      ...
      {showViewModal && selectedFault && (
        ...
        <div className="modal-overlay">
          ...
          <div className="modal-box view-modal">
            ...
            <p className="modal-description">
              Review the selected fault and launch the AR experience if needed.
            </p>
            ...
            <div className="view-details-grid">
              ...
              <div>
                ...
                <p>
                  {
                    selectedFault.detected_at
                      ? selectedFault.detected_at.split(' ')[0]
                      : 'N/A'
                  }
                </p>
              </div>
      ...
      {showArPlaceholder && (
        ...
        <div className="modal-overlay">
          ...
          <div className="modal-box view-modal">
            ...
            <p className="modal-description">
              AR view is not implemented here yet.
              This placeholder represents the future immersive inspection screen.
            </p>
